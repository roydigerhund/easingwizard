...
export const presetData = {
  ...
  SPRING: [
    ...
    },
    {
      ...
      output: {
        css: 'linear(0, 0.115 2.2%, 0.878 9.4%, 1.016 11.9%, 1.081 14.7%, 1.088 16%, 1.084 17.5%, 1.013 25.3%, 0.993 30.8%, 1.001 46.7%, 1)',
        tailwind_css:
          'ease-[linear(0,0.115_2.2%,0.878_9.4%,1.016_11.9%,1.081_14.7%,1.088_16%,1.084_17.5%,1.013_25.3%,0.993_30.8%,1.001_46.7%,1)]',
        svg_polyline:
          '0,100 2.2,94.25 9.4,56.1 11.9,49.2 14.7,45.95 16,45.6 17.5,45.8 25.3,49.35 30.8,50.35 46.7,49.95 100,50',
      },
    },
    {
      id: '0a1h50v',
    ...
    },
    {
      ...
      output: {
        css: 'linear(0, 0.027 1.4%, 0.115 3.1%, 0.853 13%, 0.992 16.4%, 1.063 20.1%, 1.076 22.2%, 1.075 24.7%, 1.013 35.8%, 0.995 43.3%, 1)',
        tailwind_css:
          'ease-[linear(0,0.027_1.4%,0.115_3.1%,0.853_13%,0.992_16.4%,1.063_20.1%,1.076_22.2%,1.075_24.7%,1.013_35.8%,0.995_43.3%,1)]',
        svg_polyline:
          '0,100 1.4,98.65 3.1,94.25 13,57.35 16.4,50.4 20.1,46.85 22.2,46.2 24.7,46.25 35.8,49.35 43.3,50.25 100,50',
      },
    },
  ],
  BOUNCE: [
