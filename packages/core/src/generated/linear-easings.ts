...
export const springCalculations: Record<SpringCurve, Value> = {
  heavy: {
    easingValue:
...
export const bounceCalculations: Record<BounceCurve, Value> = {
  firm: {
    easingValue:
...
export const wiggleCalculations: Record<WiggleCurve, Value> = {
  subtle: {
    easingValue:
...
export const overshootCalculations: Record<OvershootStyle, Record<OvershootCurve, Value>> = {
  in: {
    soft: {
      easingValue:
