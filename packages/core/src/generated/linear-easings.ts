...
export const springCalculations: Record<SpringCurveKey, Value> = {
  HEAVY: {
    easingValue:
  ...
  LAZY: {
    easingValue:
      'linear(0, 0.009 1.4%, 0.032 2.8%, 0.131 6%, 0.265 9.1%, 0.675 17.6%, 0.88 22.8%, 0.953 25.2%, 1.014 27.7%, 1.062 30.3%, 1.094 32.9%, 1.121 37.2%, 1.121 42.2%, 1.102 46.7%, 1.019 61.2%, 0.989 71.5%, 0.985 81.1%, 1)',
    sampledPoints: [
      {
        x: 0,
        y: 100,
...
export const bounceCalculations: Record<BounceCurveKey, Value> = {
  FIRM: {
    easingValue:
...
export const wiggleCalculations: Record<WiggleCurveKey, Value> = {
  SUBTLE: {
    easingValue:
...
export const overshootCalculations: Record<OvershootStyleKey, Record<OvershootCurveKey, Value>> = {
  IN: {
    SOFT: {
      easingValue:
        'linear(0, -0.013 10.3%, -0.059 19.9%, -0.13 28.7%, -0.308 46.7%, -0.363 54.4%, -0.377 58.3%, -0.378 62%, -0.366 65.5%, -0.34 68.8%, -0.28 73.3%, -0.19 77.6%, -0.07 81.7%, 0.079 85.6%, 0.472 93%, 1)',
      sampledPoints: [
        {
          x: 0,
          y: 100,
  ...
  OUT: {
    SOFT: {
      easingValue:
        'linear(0, 0.528 7%, 0.921 14.4%, 1.07 18.3%, 1.19 22.4%, 1.28 26.7%, 1.34 31.2%, 1.366 34.5%, 1.378 38%, 1.377 41.7%, 1.363 45.6%, 1.308 53.3%, 1.13 71.3%, 1.059 80.1%, 1.013 89.7%, 1)',
      sampledPoints: [
        {
          x: 0,
          y: 100,
  ...
  IN_OUT: {
    SOFT: {
      easingValue:
        'linear(0, -0.011 5.5%, -0.053 10.6%, -0.115 15.2%, -0.269 24.6%, -0.316 28.4%, -0.333 31.8%, -0.32 34.9%, -0.285 37.2%, -0.228 39.4%, -0.047 43.5%, 0.219 47.2%, 0.952 55%, 1.158 58.7%, 1.285 62.8%, 1.33 66.6%, 1.333 68.7%, 1.322 70.9%, 1.272 75.2%, 1.115 84.8%, 1.051 89.5%, 1.011 94.5%, 1)',
      sampledPoints: [
        {
          x: 0,
          y: 100,
