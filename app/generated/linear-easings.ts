...
export const springCalculations = {
  ...
  glide: {
    easingValue:
      'linear(0, 0.012 0.9%, 0.049 2%, 0.409 9.3%, 0.513 11.9%, 0.606 14.7%, 0.691 17.9%, 0.762 21.3%, 0.82 25%, 0.868 29.1%, 0.907 33.6%, 0.937 38.7%, 0.976 51.3%, 0.994 68.8%, 1)',
    sampledPoints: [
      {
        x: 0,
        y: 100,
  ...
  snap: {
    easingValue:
      'linear(0, 0.115 2.2%, 0.877 9.4%, 1.016 11.9%, 1.081 14.7%, 1.088 16%, 1.084 17.5%, 1.013 25.3%, 0.993 30.8%, 1.001 46.8%, 1)',
    sampledPoints: [
      {
        x: 0,
        y: 100,
...
export const bounceCalculations = {
  ...
  sharp: {
    easingValue:
      'linear(0, 1 37.8%, 0.883 44.2%, 0.855 47.1%, 0.846 50%, 0.853 52.7%, 0.875 55.5%, 1 65.5%, 0.967 69.4%, 0.957 73.1%, 0.964 76.5%, 1 84.5%, 0.993 89.3%, 1)',
    sampledPoints: [
      {
        x: 0,
        y: 100,
